...
class Config:
    ...
    SPRINT_VIEWER_V2_ENABLED = os.getenv("SPRINT_VIEWER_V2_ENABLED", "false").lower() == "true"
    SPRINT_VIEWER_FIELD_MAPPING_FILE = os.getenv("SPRINT_VIEWER_FIELD_MAPPING_FILE", "")
    SPRINT_VIEWER_ANALYSIS_CONFIG = {}
